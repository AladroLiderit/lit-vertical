...
class event_registration(models.Model):
    ...
    caracteristicas_registro = fields.Many2many('event_advanced.caracteristicas_registro', 'caratecteristicas', 'registro_id','caracteristica_id', string='Características')
    ...
    pago_inscripcion_registro = fields.Float(string='Pago de inscripción', digits_compute=dp.get_precision('Product Price'), default=_get_importe_reserva)
    #forma_pago_registro = fields.Many2one('event_advanced.forma_pago_registro', string='Forma de pago', required=False)
    pago_resto_registro = fields.Float(string='Pago del resto', compute='_compute_pago_resto_registro', digits_compute=dp.get_precision('Product Price'), readonly=True, store=True)
    ...
    total_inscripcion = fields.Float(string='Total de inscripción', compute='_compute_total_inscripcion', digits_compute=dp.get_precision('Product Price'), readonly=True, store=True)
    ...
    @api.one
    @api.depends('pago_inscripcion_registro')
    def _compute_pago_resto_registro(self):
        self.pago_resto_registro = self.event_id.precio_total_event - self.event_id.descuento_event - self.pago_inscripcion_registro
    ...
    @api.onchange('pago_inscripcion_registro')
